...
class OwidContinent(db.Model, AllLocationGroupMixin):

    __tablename__ = "owid_location_group"
    __mapper_args__ = {"concrete": True}
    __table_args__ = (
        db.UniqueConstraint("location_group", name="owid_location_group_uix"),
    )

    id_seq = Sequence('owid_location_group_id_seq')
