...
from project.web_admin.services.database_import_status import \
    DatabaseImportStatusService
from project.web_admin.services.database_table_row_count import \
    DatabaseTableRowCountService
from project.web_admin.web_admin_service import WebAdminService


database_table_row_count = DatabaseTableRowCountService(db)
database_import_status = DatabaseImportStatusService(db)
...
class AppAdminUrls:
    ...
    def url_admin_status():
        ...
        return render_template(
            "app_web_admin/db_dump_and_reimport/admin_status.html", page_info=page_info)
    ...
    def url_admin_info():
        ...
        return render_template(
            "app_web_admin/db_dump_and_reimport/admin_info.html", page_info=page_info)
