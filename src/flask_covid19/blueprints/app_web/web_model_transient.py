class WebPageContent:
    ...
    def __init__(self, default_title, default_subtitle=None, default_subtitle_info=None):
        ...
        if self.subtitle is None:
            self.subtitle = """Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam."""
        if self.subtitle_info is None:
            self.subtitle_info = """Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod 
