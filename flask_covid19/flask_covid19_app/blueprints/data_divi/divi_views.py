...
from flask_covid19_app_web.web_dispachter_matrix_service import divi_service
...
def task_divi_download(self):
    ...
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_divi_download [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_divi_import_file(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_divi_import_file [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_divi_full_update_dimension_tables(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_divi_full_update_dimension_tables [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_divi_update_dimension_tables(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_divi_update_dimension_tables [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_divi_full_update_fact_table(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_divi_full_update_fact_table [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_divi_update_fact_table(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_divi_update_fact_table [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_divi_full_update(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_divi_full_update [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_divi_update(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_divi_update [OK] ")
    logger.info("------------------------------------------------------------")
    divi_service.update()
    self.update_state(state=states.SUCCESS)
...
def url_task_divi_import():
    ...
    task_divi_import_file.apply_async()
...
def url_task_divi_full_update_dimension_tables():
    ...
    task_divi_full_update_dimension_tables.apply_async()
...
def url_task_divi_update_dimension_tables():
    ...
    task_divi_update_dimension_tables.apply_async()
...
def url_task_divi_full_update_fact_table():
    ...
    task_divi_full_update_fact_table.apply_async()
...
def url_task_divi_update_fact_table():
    ...
    task_divi_update_fact_table.apply_async()
...
def url_task_divi_full_update():
    ...
    divi_service.download()
    flash("divi_service.download ok")
    task_divi_full_update.apply_async()
