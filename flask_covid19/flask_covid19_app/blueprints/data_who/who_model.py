...
from flask_covid19_app_all.all_model import AllDateReported, BlueprintFactTable
from flask_covid19_app_all.all_model import AllLocationGroup, AllLocation
