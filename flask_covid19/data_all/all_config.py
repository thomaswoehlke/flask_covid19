...
from flask_covid19.app_config.database import root_dir
...
class BlueprintConfig:
    def __init__(
        ...
        self.cvsfile_backup_path = (
            self.data_path
            + os.sep
            + self.cvsfile_subpath
            + os.sep
            + self.cvsfile_backup_name
        )
        self.cvsfile_path = (
            self.data_path + os.sep + self.cvsfile_subpath + os.sep + self.cvsfile_name
        )
        ...
        self.msg_ok = (
            "downloaded FILE: " + self.cvsfile_path + " <--- from " + self.url_src
        )
        self.msg_error = (
