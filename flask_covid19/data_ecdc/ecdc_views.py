...
class EcdcUrls:
    ...
    def url_ecdc_info():
        ...
        return render_template(
            "ecdc/ecdc_info.html", title="Europe", page_info=page_info
        )
    ...
    def url_ecdc_date_reported_one(date_reported_id, page=1):
        ...
        page_data = EcdcData.get_by_date_reported_order_by_notification_rate(
            ecdc_date_reported, page
        )
        return render_template(
    ...
    @staticmethod
    @app_ecdc.route(
        "/date_reported/notification_rate/<int:date_reported_id>/page/<int:page>"
    )
    ...
    @staticmethod
    @app_ecdc.route(
        "/date_reported/deaths_weekly/<int:date_reported_id>/page/<int:page>"
    )
    ...
    def url_ecdc_date_reported_one_deaths_weekly(date_reported_id, page=1):
        page_info = WebPageContent("ECDC", "date_reported")
        ecdc_date_reported = EcdcDateReported.get_by_id(date_reported_id)
        page_data = EcdcData.get_by_date_reported_order_by_deaths(
            ecdc_date_reported, page
        )
        return render_template(
    ...
    @staticmethod
    @app_ecdc.route(
        "/date_reported/cases_weekly/<int:date_reported_id>/page/<int:page>"
    )
    ...
    def url_ecdc_date_reported_one_cases_weekly(date_reported_id, page=1):
        page_info = WebPageContent("ECDC", "date_reported")
        ecdc_date_reported = EcdcDateReported.get_by_id(date_reported_id)
        page_data = EcdcData.get_by_date_reported_order_by_cases(
            ecdc_date_reported, page
        )
        return render_template(
...
class EcdcTestUrls:
    ...
    def url_ecdc_test_ecdc_import_countries():
        ...
        app.logger.info(
            "url_ecdc_test_ecdc_import_countries - START: EcdcImport.countries()"
        )
        i = 0
    ...
    def url_ecdc_test_ecdc_data_get_datum_of_all_ecdc_data():
        app.logger.info(
            "url_ecdc_test_ecdc_data_get_datum_of_all_ecdc_data - DONE: EcdcData.get_datum_of_all_ecdc_data()"
        )
        flash(
            "url_ecdc_test_ecdc_data_get_datum_of_all_ecdc_data - START: EcdcData.get_datum_of_all_ecdc_data()"
        )
    ...
    def url_ecdc_test_ecdc_data_get_datum_of_all_ecdc_import():
        app.logger.info(
            "url_ecdc_test_ecdc_data_get_datum_of_all_ecdc_import - START: EcdcImport.get_datum_of_all_ecdc_import()"
        )
        flash(
            "url_ecdc_test_ecdc_data_get_datum_of_all_ecdc_import - START: EcdcImport.get_datum_of_all_ecdc_import()"
        )
        for datum in EcdcImport.get_datum_of_all_ecdc_import():
            app.logger.info(str(datum))
        flash(
            "url_ecdc_test_ecdc_data_get_datum_of_all_ecdc_import - DONE: EcdcImport.get_datum_of_all_ecdc_import()"
        )
        app.logger.info(
            "url_ecdc_test_ecdc_data_get_datum_of_all_ecdc_import - DONE: EcdcImport.get_datum_of_all_ecdc_import()"
        )
    ...
    @staticmethod
    @app_ecdc.route(
        "/test/ecdc_service/service_update/ecdc_import_get_new_dates_as_array"
    )
    @login_required
    def url_ecdc_test_ecdc_service_ecdc_import_get_new_dates_as_array():
        app.logger.info(
            "url_ecdc_test_ecdc_import_get_new_dates_as_array - START: EcdcService.ecdc_import_get_new_dates_as_array()"
        )
        flash(
            "url_ecdc_test_ecdc_import_get_new_dates_as_array - START: EcdcService.ecdc_import_get_new_dates_as_array()"
        )
        for datum in ecdc_service.service_update.ecdc_import_get_new_dates_as_array():
            app.logger.info(str(datum))
        flash(
            "url_ecdc_test_ecdc_import_get_new_dates_as_array - DONE: EcdcService.ecdc_import_get_new_dates_as_array()"
        )
        app.logger.info(
            "url_ecdc_test_ecdc_import_get_new_dates_as_array - DONE: EcdcService.ecdc_import_get_new_dates_as_array()"
        )
