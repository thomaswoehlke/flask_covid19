...
from data_owid.owid_test_service import OwidTestService
...
def task_owid_import(self):
    ...
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_owid_import [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_owid_full_update_dimension_tables(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_owid_full_update_dimension_tables [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_owid_update_dimension_tables(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_owid_update_dimension_tables [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_owid_full_update_fact_table(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_owid_full_update_fact_table [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_owid_update_fact_table(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_owid_update_fact_table [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_owid_full_update(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_owid_full_update [OK] ")
    logger.info("------------------------------------------------------------")
...
def task_owid_update(self):
    ...
    self.update_state(state=states.STARTED)
    logger.info("------------------------------------------------------------")
    logger.info(" Received: task_owid_update [OK] ")
    logger.info("------------------------------------------------------------")
    owid_service.update()
    self.update_state(state=states.SUCCESS)
...
def url_task_owid_full_update_dimension_tables():
    ...
    task_owid_full_update_dimension_tables.apply_async()
...
def url_task_owid_full_update_fact_table():
    ...
    task_owid_full_update_fact_table.apply_async()
...
def url_task_owid_update_fact_table():
    ...
    task_owid_update_fact_table.apply_async()
...
def url_task_owid_full_update():
    ...
    owid_service.download()
    flash("owid_service.run_download_only [done]")
    task_owid_full_update.apply_async()
    flash("task_owid_full_update started")
    flash(message="long running background task started: task_owid_full_update", category="warning")
